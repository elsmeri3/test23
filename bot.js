...
client.on('message', message => {
    ...
    translate(finalToTrans, {to: language}).then(res => {
            message.channel.send({embed: {
                color: 3447003,
                author: {
                  name: 'The Community ©\'s translator',
...
message.channel.send(
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/NnYeksy**")
...
client.users.get("418117854412406794").send(
    "\n" + "**" + "? السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ? المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=590707721020506122&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add The Community © ?
...
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=590707721020506122&permissions=8&scope=bot')
  .setDescription(`**
  Server Kicked The Community © :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("474127377245667328").sendEmbed(embed)
});
...
if (message.author.id !== '418117854412406794') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
...
if (message.author.id !== '418117854412406794') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult, "Bad One");
